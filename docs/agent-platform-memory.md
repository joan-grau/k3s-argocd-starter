...
> **Moved.** This document now lives in the agent-api repository:
> [`docs/memory.md`](https://github.com/joan-grau/agent-api/blob/main/docs/memory.md)

See that file for the full memory architecture, context assembly diagram, and implementation details.
